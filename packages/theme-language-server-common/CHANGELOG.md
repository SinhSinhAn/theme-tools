...
- ae37297b: Update LiquidDocTagCompletionProvider to support completions for free-form text nodes
- b1f92c63: Display filter parameter documentation on hover
